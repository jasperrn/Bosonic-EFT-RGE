...
Local Phi4D2L1 = ( + sym(a1,a2)*sym(a3,a4)*l * (  - 4/9*T(a3,a1,B1)*T(a4,a2,B2
...
Local Phi4D2L2 = ( + sym(a1,a2)*sym(a3,a4)*l^2 * ( 91/18*f(B1,B2,B3)*f(B1,B3,
         B4)*T(a3,a1,B5)*T(a4,a2,B4)*cPhi1F2(b7,B6,B2)*cPhi1F2(b7,B6,B5)
...
Local F3L1 = ( + asym(A3,A1,A2)*l * ( 12*f(B4,B5,A2)*cPhi1F2(b1,B4,A1)*
         cPhi1F2(b1,B5,A3) ));


Local F3L2 = ( + asym(A3,A1,A2)*l^2 * (  - 2/3*f(B4,A3,A2)*T(b4,b3,B5)*T(b4,b3
         ,B6)*cPhi1F2(b5,B5,B4)*cPhi1F2(b5,B6,A1)
...
Local Phi2F2L1 = ( + sym(a1,b1)*sym(A3,A4)*l * ( 12*f(B3,B4,B5)*T(b4,a1,B5)*
         cPhi1F2(b1,A3,B4)*cPhi1F2(b4,A4,B3)*i_
...
Local Phi2F2L2 = ( + sym(a1,b1)*sym(A3,A4)*l^2 * ( 272/3*f(B3,B4,A4)*f(B3,B4,
         B5)*f(B5,B6,B7)*f(B7,B8,B9)*cPhi1F2(a1,B8,B6)*cPhi1F2(b1,A3,B9)
...
Local Phi6L1 = ( + sym(a1,a2,a3,a4,a5,a6)*l * (  - 20*lam(a1,a5,a6,b8)*lam(a2,
         a3,a4,b7)*cPhi1F2(b7,B2,B1)*cPhi1F2(b8,B2,B1)
...
Local Phi6L2 = ( + sym(a1,a2,a3,a4,a5,a6)*l^2 * (  - 340*f(B1,B2,B3)*f(B1,B2,
         B4)*lam(a1,a5,a6,b8)*lam(a2,a3,a4,b7)*cPhi1F2(b7,B5,B4)*cPhi1F2(b8,B5
         ,B3)
       ...
       - 11520*f(B1,B2,B3)*T(b12,a3,B1)*T(b12,a4,B5)*T(b13,a5,B2)*T(b14,a1,B4)
         *T(b14,a6,B5)*cPhi1F2(a2,B6,B4)*cPhi1F2(b13,B6,B3)*i_
       - 11520*f(B1,B2,B3)*T(b12,a3,B2)*T(b13,a4,B1)*T(b13,a5,B5)*T(b14,a1,B4)
         *T(b14,a6,B6)*cPhi1F2(a2,B5,B4)*cPhi1F2(b12,B6,B3)*i_
       - 5760*f(B1,B2,B3)*T(b12,a3,B5)*T(b12,a4,B1)*T(b13,a5,B5)*T(b13,a6,B4)*
         T(b14,a1,B2)*cPhi1F2(a2,B6,B3)*cPhi1F2(b14,B6,B4)*i_
       - 5760*f(B1,B2,B3)*T(b12,a3,B6)*T(b12,a4,B5)*T(b13,a5,B2)*T(b14,a1,B4)*
         T(b14,a6,B6)*cPhi1F2(a2,B4,B1)*cPhi1F2(b13,B5,B3)*i_
       + 8640*f(B1,B2,B3)*T(b12,a4,B1)*T(b12,a5,B6)*T(b13,a6,B2)*T(b14,a1,B5)*
         T(b14,b13,B4)*cPhi1F2(a2,B5,B3)*cPhi1F2(a3,B6,B4)*i_
       + 8640*f(B1,B2,B3)*T(b12,a4,B1)*T(b12,a5,B6)*T(b13,a6,B2)*T(b14,a1,B5)*
         T(b14,b13,B4)*cPhi1F2(a2,B6,B5)*cPhi1F2(a3,B4,B3)*i_
       - 4320*f(B1,B2,B3)*T(b12,a4,B1)*T(b13,a5,B2)*T(b13,b12,B5)*T(b14,a1,B4)
         *T(b14,a6,B5)*cPhi1F2(a2,B6,B3)*cPhi1F2(a3,B6,B4)*i_
       - 4320*f(B1,B2,B3)*T(b12,a4,B1)*T(b13,a5,B2)*T(b13,b12,B6)*T(b14,a1,B4)
         *T(b14,a6,B5)*cPhi1F2(a2,B6,B5)*cPhi1F2(a3,B4,B3)*i_
       ...
       + 4320*f(B1,B2,B3)*T(b12,a4,B3)*T(b13,a5,B1)*T(b13,b12,B5)*T(b14,a1,B4)
         *T(b14,a6,B2)*cPhi1F2(a2,B6,B5)*cPhi1F2(a3,B6,B4)*i_
       ...
       + 8640*f(B1,B2,B3)*T(b12,a4,B5)*T(b12,a5,B1)*T(b13,a6,B2)*T(b14,a1,B4)*
         T(b14,b13,B5)*cPhi1F2(a2,B6,B3)*cPhi1F2(a3,B6,B4)*i_
       - 8640*f(B1,B2,B3)*T(b12,a4,B5)*T(b12,a5,B1)*T(b13,a6,B5)*T(b14,a1,B2)*
         T(b14,b13,B4)*cPhi1F2(a2,B6,B4)*cPhi1F2(a3,B6,B3)*i_
