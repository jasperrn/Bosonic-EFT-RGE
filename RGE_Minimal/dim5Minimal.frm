...
Local Phi5L1 = (( + sym(a1,a2,a3,a4,a5)*l * ( 10*lam(a1,a5,b6,b7)*cPhi5(a2,a3,
         a4,b6,b7)
...
Local Phi5L2 = (( + sym(a1,a2,a3,a4,a5)*l^2 * ( 440*f(B1,B2,B3)*f(B1,B3,B4)*
         lam(a2,a3,a4,b8)*T(b9,a1,B5)*T(b9,a5,B4)*cPhi1F2(b8,B5,B2)
