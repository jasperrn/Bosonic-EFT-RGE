...
Local Phi4D2L1 = (( + sym(a1,a2)*sym(a3,a4)*l * (  - 4/3*lam(a2,a4,b5,b6)*
         cPhi4D2(a3,a1,b6,b5)
...
Local Phi4D2L2 = (( + sym(a1,a2)*sym(a3,a4)*l^2 * (  - 4/3*cF3(B1,B2,B3)*lam(
...
Local Phi6L1 = (( + sym(a1,a2,a3,a4,a5,a6)*l * ( 15*lam(a1,a6,b7,b8)*cPhi6(a2,
         a3,a4,a5,b7,b8)
...
Local Phi6L2 = (( + sym(a1,a2,a3,a4,a5,a6)*l^2 * (  - 200*cF3(B1,B2,B3)*lam(a2
         ,a3,a4,b10)*lam(a5,a6,b11,b12)*T(b12,b10,B3)*T(b13,a1,B2)*T(b13,b11,
         B1)*i_
       + 1320*cF3(B1,B2,B3)*lam(a2,a3,a4,b12)*T(b13,a5,B4)*T(b13,b12,B3)*T(b14
         ,a6,B4)*T(b15,a1,B2)*T(b15,b14,B1)*i_
       ...
       - 2920*f(B1,B2,B3)*lam(a2,a3,a4,b10)*T(b11,a6,B3)*T(b12,a1,B2)*T(b13,
         b11,B1)*cPhi4D2(b13,a5,b12,b10)*i_
       - 8260/3*f(B1,B2,B3)*lam(a2,a3,a4,b10)*T(b12,b10,B3)*T(b12,b11,B1)*T(
         b13,b11,B2)*cPhi4D2(a6,a5,b13,a1)*i_
