...
Local Phi2D2L1 = ( + sym(a1,a2)*l*ep^-1 * (  - 2*T(b5,a1,B1)*T(b5,a2,B1) ));


Local Phi2D2L2 = ( + sym(a1,a2)*l^2*ep^-2 * (  - 9*f(B1,B2,B3)*T(b6,a2,B1)*T(
         b7,a1,B2)*T(b7,b6,B3)*I
...
Local F2L1 = ( + sym(A1,A2)*l*ep^-1 * ( 11/3*f(A1,B3,B4)*f(A2,B3,B4)
       + 1/6*T(b4,b3,A1)*T(b4,b3,A2) ));


Local F2L2 = ( + sym(A1,A2)*l^2*ep^-1 * ( 17/3*f(A1,B3,B5)*f(A2,B3,B4)*f(B4,B6
         ,B7)*f(B5,B6,B7)
       + 1/6*f(A1,B3,B5)*f(A2,B3,B4)*T(b4,b3,B4)*T(b4,b3,B5)
       - T(b6,b5,A2)*T(b7,b5,A1)*T(b8,b6,B3)*T(b8,b7,B3) ));


Local Phi4L1 = ( + sym(a1,a2,a3,a4)*l*ep^-1 * ( 3/2*lam(a1,a4,b5,b6)*lam(a2,a3
         ,b5,b6)
       + 6*lam(a2,a3,b7,b8)*T(b7,a1,B1)*T(b8,a4,B1)
       + 18*T(b9,a2,B1)*T(b9,a3,B2)*T(b10,a1,B1)*T(b10,a4,B2) ));


Local Phi4L2 = ( + sym(a1,a2,a3,a4)*l^2*ep^-2 * ( 3*f(B1,B2,B3)*lam(a2,a3,b8,
         b9)*T(b9,a4,B1)*T(b10,a1,B2)*T(b10,b8,B3)*I
       ...
       + sym(a1,a2,a3,a4)*l^2*ep^-1 * (  - 81*f(B1,B2,B3)*f(B3,B4,B5)*T(b9,a2,
         B1)*T(b9,a3,B5)*T(b10,a1,B2)*T(b10,a4,B4)
