...
Local Phi2D4L1 = ( + sym(a1,a2)*l * (  - 2*cPhi1F2(a1,b6,b5)*cPhi1F2(a2,b6,b5)
       - dPhi3D2(a1,b6,b5)*dPhi3D2(a2,b6,b5) ));


Local Phi2D4L2 = ( + sym(a1,a2)*l^2 * ( 34*f(B1,B2,B3)*f(B1,B3,B4)*cPhi1F2(a1,
         B2,b5)*cPhi1F2(a2,B4,b5)
...
Local Phi4D2cL1 = ( + sym(a1,a2)*sym(a3,a4)*l * ( 1/3*lam(a2,a4,b5,b6)*
...
Local Phi4D2cL2 = ( + sym(a1,a2)*sym(a3,a4)*l^2 * (  - 9/8*f(B1,B2,B3)*f(B1,B3
         ,B4)*T(a3,a1,B2)*T(b8,b7,B4)*dPhi3D2(b10,b7,a2)*dPhi3D2(b10,b8,a4)
...
Local Phi4D2dL1 = ( + sym(a1)*sym(a2,a3,a4)*l * (  - lam(a1,a3,b5,b6)*dPhi3D2(
         b8,b5,a2)*dPhi3D2(b8,b6,a4)
...
Local Phi4D2dL2 = ( + sym(a1)*sym(a2,a3,a4)*l^2 * (  - 250/3*f(B1,B2,B3)*f(B1,
...
Local F2D2L1 = ( + sym(A1,A2)*l * ( 4/3*cPhi1F2(b1,A1,b4)*cPhi1F2(b1,A2,b4) ));


Local F2D2L2 = ( + sym(A1,A2)*l^2 * (  - 86/9*f(B3,B4,A2)*T(b3,b2,B4)*cPhi1F2(
...
Local F3L1 = ( + asym(A3,A1,A2)*l * (  - 12*f(B4,A2,B5)*cPhi1F2(b1,B4,A1)*
         cPhi1F2(b1,B5,A3) ));


Local F3L2 = ( + asym(A3,A1,A2)*l^2 * ( 3*f(B4,A2,A3)*T(b4,b3,B4)*T(b5,b3,B5)*
...
Local Phi2F1D2L1 = ( + asym(a2,a1)*sym(A3)*l * (  - 34/3*T(b4,a1,B2)*cPhi1F2(
         a2,B3,B2)*cPhi1F2(b4,B3,A3)*I
       - 1/3*T(b5,b4,A3)*dPhi3D2(b7,b4,a1)*dPhi3D2(b7,b5,a2)*I ));


Local Phi2F1D2L2 = ( + asym(a2,a1)*sym(A3)*l^2 * (  - 37/3*f(B2,B3,B4)*f(B2,B4
...
Local Phi2F2L1 = ( + sym(a1,a2)*sym(A3,A4)*l * ( 24*f(B3,B4,B5)*T(b4,a1,B5)*
...
Local Phi2F2L2 = ( + sym(a1,a2)*sym(A3,A4)*l^2 * ( 272/3*f(B3,B4,B5)*f(B3,B4,
         A4)*f(B5,B6,B7)*f(B7,B8,B9)*cPhi1F2(a1,B8,B6)*cPhi1F2(a2,B9,A3)
...
Local Phi6L1 = ( + sym(a1,a2,a3,a4,a5,a6)*l * (  - 180*lam(a2,a3,b7,b8)*lam(a4
         ,a5,b7,b9)*dPhi3D2(b8,b12,a6)*dPhi3D2(b9,b12,a1)
...
Local Phi6L2 = ( + sym(a1,a2,a3,a4,a5,a6)*l^2 * (  - 6720*f(B1,B2,B3)*f(B1,B2,
