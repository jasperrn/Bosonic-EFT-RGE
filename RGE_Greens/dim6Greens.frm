...
Local Phi2D4L1 = (( + sym(a1,a2)*l * (  - 4*T(b4,a1,B1)*dPhi2F1D2(a2,b4,B1)*i_
       + 2*T(b5,a1,B1)*T(b5,a2,B2)*dF2D2(B2,B1)
       - 8*T(b5,a2,B1)*T(b6,a1,B1)*dPhi2D4(b6,b5) ))
-2*sym(a1,a2)*gammaPhiL1(a1,b0)*dPhi2D4(b0,a2));


Local Phi2D4L2 = (( + sym(a1,a2)*l^2 * ( 7/3*cF3(B1,B2,B4)*f(B1,B2,B3)*T(b5,a1
         ,B4)*T(b5,a2,B3)
       - 125/6*f(B1,B2,B3)*T(b5,a2,B1)*T(b6,a1,B2)*dPhi2F1D2(b5,b6,B3)
       - 31/6*f(B1,B2,B3)*T(b6,a2,B1)*T(b7,a1,B2)*T(b7,b6,B4)*dF2D2(B4,B3)*i_
       ...
       - 5/3*T(b6,a1,B1)*T(b8,b7,B1)*T(b8,b7,B2)*dPhi2F1D2(a2,b6,B2)*i_
       - 5/3*T(b6,a1,B2)*T(b6,a2,B1)*T(b8,b7,B1)*dPhi2F1D2(b7,b8,B2)*i_
       + 14/3*T(b6,a2,B1)*T(b7,a1,B1)*T(b8,b7,B2)*dPhi2F1D2(b6,b8,B2)*i_
...
Local Phi4D2cL1 = (( + sym(a1,a2)*sym(a3,a4)*l * (  - 4/3*lam(a2,a4,b5,b6)*
         cPhi4D2(a3,a1,b6,b5)
       + 4/3*lam(a2,a4,b5,b6)*cPhi4D2(b5,a1,b6,a3)
       - 2*lam(a2,a4,b6,b7)*T(b6,a1,B1)*dPhi2F1D2(a3,b7,B1)*i_
       ...
       + 2*lam(a3,a4,b6,b7)*T(b6,a1,B1)*dPhi2F1D2(a2,b7,B1)*i_
       - lam(a3,a4,b7,b8)*T(b7,a1,B1)*T(b8,a2,B2)*dF2D2(B2,B1)
       - 3*T(a3,a2,B1)*T(b8,a1,B2)*T(b9,b8,B2)*dPhi2F1D2(a4,b9,B1)*i_
       + 3*T(a4,a2,B1)*T(b8,a1,B2)*T(b9,a3,B2)*dPhi2F1D2(b8,b9,B1)*i_
       ...
       - 6*T(b8,a1,B2)*T(b8,a2,B1)*T(b9,a3,B1)*dPhi2F1D2(a4,b9,B2)*i_
       + 6*T(b8,a2,B1)*T(b9,a1,B1)*T(b9,a3,B2)*dPhi2F1D2(a4,b8,B2)*i_
...
Local Phi4D2cL2 = (( + sym(a1,a2)*sym(a3,a4)*l^2 * (  - 4/3*cF3(B1,B2,B3)*lam(
         a2,a3,a4,b8)*T(b9,a1,B1)*T(b10,b8,B3)*T(b10,b9,B2)*i_
       ...
       - 1/4*lam(a1,a2,b6,b7)*lam(a3,a4,b8,b9)*T(b8,b6,B1)*dPhi2F1D2(b7,b9,B1)
         *i_
       + lam(a1,a2,b6,b7)*lam(a4,b7,b8,b9)*T(b8,b6,B1)*dPhi2F1D2(a3,b9,B1)*i_
...
Local Phi4D2dL1 = (( + sym(a1)*sym(a2,a3,a4)*l * ( 4*lam(a1,a3,b5,b6)*cPhi4D2(
         a2,a4,b6,b5)
       - 4*lam(a1,a3,b5,b6)*cPhi4D2(b6,a4,b5,a2)
       + 6*lam(a1,a3,b6,b7)*T(b6,a2,B1)*dPhi2F1D2(a4,b7,B1)*i_
       - 3*lam(a1,a3,b7,b8)*T(b7,a2,B1)*T(b8,a4,B2)*dF2D2(B2,B1)
       - 2*lam(a2,a3,a4,b6)*T(b7,a1,B1)*dPhi2F1D2(b6,b7,B1)*i_
       + 2*lam(a2,a3,a4,b7)*T(b8,a1,B1)*T(b9,b7,B1)*dPhi2D4(b9,b8)
       + 3*lam(a3,a4,b5,b6)*dPhi4D2(a1,b6,a2,b5)
       - 6*lam(a3,a4,b6,b7)*T(b6,a1,B1)*dPhi2F1D2(a2,b7,B1)*i_
       ...
       + 9*T(b8,a1,B1)*T(b8,a2,B2)*T(b9,a4,B1)*dPhi2F1D2(a3,b9,B2)*i_
       + 9*T(b8,a1,B2)*T(b8,a2,B1)*T(b9,a4,B1)*dPhi2F1D2(a3,b9,B2)*i_
       + 18*T(b8,a3,B1)*T(b9,a2,B2)*T(b9,a4,B1)*dPhi2F1D2(a1,b8,B2)*i_
...
Local Phi4D2dL2 = (( + sym(a1)*sym(a2,a3,a4)*l^2 * ( 10*cF3(B1,B2,B3)*lam(a3,
         a4,b8,b9)*T(b9,a1,B2)*T(b10,a2,B1)*T(b10,b8,B3)*i_
       ...
       + 3/2*lam(a1,b6,b8,b9)*lam(a3,a4,b6,b7)*T(b8,a2,B1)*dPhi2F1D2(b7,b9,B1)
         *i_
       - 3*lam(a1,b6,b8,b9)*lam(a3,b6,b7,b8)*T(b7,a2,B1)*dPhi2F1D2(a4,b9,B1)*
         i_
       ...
       + 6*lam(a2,b7,b8,b9)*lam(a3,a4,b6,b7)*T(b8,b6,B1)*dPhi2F1D2(a1,b9,B1)*
         i_
...
Local F2D2L1 = (( + sym(A1,A2)*l * (  - 2*cF3(A2,B3,B4)*f(A1,B3,B4)
       + 25/3*f(A1,B3,B5)*f(A2,B3,B4)*dF2D2(B5,B4)
       + 2/3*T(b3,b2,A2)*dPhi2F1D2(b2,b3,A1)*i_ ))
-2*sym(A1,A2)*gammaAL1(A1,B0)*dF2D2(B0,A2));


Local F2D2L2 = (( + sym(A1,A2)*l^2 * (  - 13/9*cF3(A2,B3,B4)*f(B3,B4,B5)*T(b4,
         b3,A1)*T(b4,b3,B5)
       - 56/9*cF3(A2,B3,B7)*f(A1,B3,B4)*f(B4,B5,B6)*f(B5,B6,B7)
       + 469/18*f(A1,B3,B5)*f(A2,B3,B4)*f(B4,B6,B7)*f(B6,B7,B8)*dF2D2(B8,B5)
       + 19/36*f(A1,B3,B5)*f(A2,B3,B4)*T(b3,b2,B4)*dPhi2F1D2(b2,b3,B5)*i_
       + 247/72*f(A1,B3,B5)*f(A2,B3,B4)*T(b4,b3,B4)*T(b4,b3,B6)*dF2D2(B6,B5)
       - 4/3*T(b4,b3,A2)*T(b5,b3,B3)*cPhi2F2(b4,b5,B3,A1)
       - 8*T(b5,b4,A2)*T(b6,b4,B3)*T(b7,b5,B3)*dPhi2F1D2(b6,b7,A1)*i_ ))
-2*sym(A1,A2)*gammaAL2(A1,B0)*dF2D2(B0,A2));


Local F3L1 = (( + asym(A1,A2,A3)*l * ( 12*cF3(A2,A3,B6)*f(A1,B4,B5)*f(B4,B5,B6
         ) ))
-3*asym(A1,A2,A3)*gammaAL1(A1,B0)*cF3(B0,A2,A3));


Local F3L2 = (( + asym(A1,A2,A3)*l^2 * (  - 29/6*cF3(A2,A3,B5)*f(B4,B5,B6)*f(
...
Local Phi2F1D2L1 = (( + asym(a1,a2)*sym(A3)*l * (  - cF3(A3,B2,B3)*f(B2,B3,B4)
         *T(a1,a2,B4)*i_
       - 3/2*f(A3,B2,B3)*f(B2,B3,B4)*T(a1,a2,B5)*dF2D2(B5,B4)*i_
       - 9*f(A3,B2,B3)*T(b4,a1,B2)*dPhi2F1D2(a2,b4,B3)*i_
       + 2/3*T(b5,a2,B2)*T(b6,a1,A3)*dPhi2F1D2(b5,b6,B2)
       + 4*T(b5,a2,B2)*T(b6,a1,B2)*dPhi2F1D2(b5,b6,A3)
       + 4/3*T(b5,b4,A3)*cPhi4D2(b5,a2,b4,a1)*i_
       + 1/3*T(b6,a2,B2)*T(b7,a1,A3)*T(b7,b6,B3)*dF2D2(B3,B2)*i_ ))
-2*asym(a1,a2)*sym(A3)*gammaPhiL1(a1,b0)*dPhi2F1D2(b0,a2,A3)
-asym(a1,a2)*sym(A3)*gammaAL1(A3,B0)*dPhi2F1D2(a1,a2,B0));


Local Phi2F1D2L2 = (( + asym(a1,a2)*sym(A3)*l^2 * (  - 41/144*cF3(A3,B2,B3)*f(
         B2,B3,B4)*f(B4,B5,B6)*f(B5,B6,B7)*T(a1,a2,B7)*i_
       + 2*cF3(A3,B2,B3)*f(B2,B3,B4)*T(b6,a2,B4)*T(b7,a1,B5)*T(b7,b6,B5)*i_
       - 13/18*cF3(A3,B3,B5)*f(B2,B3,B4)*T(a1,a2,B2)*T(b7,b6,B4)*T(b7,b6,B5)*
         i_
       + 8/9*cF3(B2,B3,B5)*f(B2,B3,B4)*T(b6,a2,B4)*T(b7,a1,A3)*T(b7,b6,B5)*i_
       ...
       - 251/72*f(A3,B2,B3)*f(B2,B3,B4)*T(b6,a2,B4)*T(b7,a1,B5)*T(b7,b6,B6)*
         dF2D2(B6,B5)*i_
       - 19/4*f(A3,B2,B3)*f(B2,B4,B5)*T(b4,a1,B4)*cPhi2F2(a2,b4,B3,B5)*i_
       ...
       - 2*lam(a2,b4,b5,b6)*T(b5,a1,B2)*cPhi2F2(b4,b6,B2,A3)*i_
       + 10/3*lam(a2,b4,b5,b6)*T(b7,b5,A3)*cPhi4D2(b6,a1,b7,b4)*i_
       ...
       - 5/6*lam(a2,b6,b7,b8)*T(b7,a1,B2)*T(b9,b6,A3)*T(b9,b8,B3)*dF2D2(B3,B2)
         *i_
       + 10/9*lam(b4,b5,b6,b7)*T(b6,a1,A3)*cPhi4D2(b5,a2,b7,b4)*i_
       - 34/3*T(b6,a1,B2)*T(b8,b7,A3)*T(b9,b7,B2)*cPhi4D2(b6,a2,b9,b8)*i_
       + 34/3*T(b6,a1,B2)*T(b8,b7,A3)*T(b9,b7,B2)*cPhi4D2(b8,a2,b9,b6)*i_
       + 8/3*T(b6,a2,B2)*T(b7,a1,A3)*T(b8,b6,B3)*cPhi2F2(b7,b8,B2,B3)*i_
       - 70/27*T(b6,a2,B2)*T(b7,a1,A3)*T(b9,b8,B2)*cPhi4D2(b8,b6,b9,b7)*i_
       - 4*T(b6,a2,B2)*T(b7,a1,B2)*T(b8,b7,B3)*cPhi2F2(b6,b8,B3,A3)*i_
       ...
       + 11/6*T(b7,a2,B3)*T(b8,a1,B2)*T(b10,b9,B2)*T(b10,b9,B3)*dPhi2F1D2(b7,
         b8,A3)
       - 16*T(b7,b6,A3)*T(b8,b6,B2)*T(b9,b7,B2)*cPhi4D2(b9,a2,b8,a1)*i_
...
Local Phi2F2L1 = (( + sym(a1,a2)*sym(A3,A4)*l * ( 2*cF3(A4,B3,B4)*f(B3,B4,B5)*
         T(b5,a1,B5)*T(b5,a2,A3)
       - 12*cF3(A4,B3,B5)*f(A3,B3,B4)*T(b5,a1,B5)*T(b5,a2,B4)
       + 8*f(A4,B3,B4)*T(b4,a1,B3)*cPhi2F2(a2,b4,B4,A3)*i_
...
Local Phi2F2L2 = (( + sym(a1,a2)*sym(A3,A4)*l^2 * (  - 8*cF3(A4,B3,B4)*lam(a1,
         a2,b6,b7)*T(b8,b6,A3)*T(b9,b7,B4)*T(b9,b8,B3)*i_
...
Local Phi6L1 = (( + sym(a1,a2,a3,a4,a5,a6)*l * ( 15*lam(a1,a6,b7,b8)*cPhi6(b8,
         a2,a3,a4,a5,b7)
...
Local Phi6L2 = (( + sym(a1,a2,a3,a4,a5,a6)*l^2 * ( 2880*cF3(B1,B2,B4)*f(B1,B2,
         B3)*T(b13,a2,B6)*T(b13,a3,B5)*T(b14,a4,B6)*T(b14,a5,B3)*T(b15,a1,B4)*
         T(b15,a6,B5)
       ...
       - 180*lam(a2,a3,b10,b11)*lam(a4,a5,b11,b12)*T(b10,a6,B1)*T(b13,a1,B2)*
         T(b14,b13,B1)*dPhi2F1D2(b12,b14,B2)*i_
       + 180*lam(a2,a3,b10,b11)*lam(a4,a5,b11,b12)*T(b10,a6,B2)*T(b13,a1,B2)*
         T(b14,b12,B1)*dPhi2F1D2(b13,b14,B1)*i_
       + 180*lam(a2,a3,b10,b11)*lam(a4,a5,b11,b12)*T(b10,a6,B2)*T(b13,a1,B2)*
         T(b14,b13,B1)*dPhi2F1D2(b12,b14,B1)*i_
       ...
       + 360*lam(a2,a3,b10,b11)*lam(a4,a5,b12,b13)*T(b11,a6,B2)*T(b12,a1,B2)*
         T(b14,b10,B1)*dPhi2F1D2(b13,b14,B1)*i_
       ...
       - 180*lam(a2,a3,b12,b13)*T(b12,a5,B1)*T(b13,a4,B3)*T(b14,a6,B3)*T(b15,
         a1,B2)*T(b16,b15,B1)*dPhi2F1D2(b14,b16,B2)*i_
       + 180*lam(a2,a3,b12,b13)*T(b12,a5,B2)*T(b13,a4,B3)*T(b14,a6,B2)*T(b15,
         a1,B3)*T(b16,b15,B1)*dPhi2F1D2(b14,b16,B1)*i_
