...
Phi3D2[1] = (( + sym[a1]*sym[a2,a3]*l * ( lam[a2,a3,b4,b5]*dPhi3D2[a1,b5,b4]
...
Phi3D2[2] = (( + sym[a1]*sym[a2,a3]*l^2 * ( 58*f[B1,B2,B3]*T[b7,a1,B1]*T[b8,a2
         ,B3]*T[b8,b7,B4]*cPhi1F2[a3,B4,B2]*I
...
Phi5[1] = (( + sym[a1,a2,a3,a4,a5]*l * ( 10*lam[a1,a5,b6,b7]*cPhi5[b7,a2,a3,a4
         ,b6]
...
Phi5[2] = (( + sym[a1,a2,a3,a4,a5]*l^2 * ( 8080*f[B1,B2,B3]*f[B1,B3,B4]*T[b10,
         a3,B4]*T[b10,a4,B6]*T[b11,a1,B5]*T[b11,a5,B2]*cPhi1F2[a2,B6,B5]
